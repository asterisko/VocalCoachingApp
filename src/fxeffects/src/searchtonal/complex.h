/*ident	"@(#)ctrans:incl-master/const-headers/complex.h	1.4" */
/*******************************************************************************
...
public:
    ...
    friend  complex	polar(double, double); // ANDRE
...
inline double norm(const complex& a)
{
	//return sqrt(a.re*a.re + a.im*a.im);
	return (a.re*a.re + a.im*a.im); // changed as suggetsed by Dr. Ferreira - ratna
}
...
inline complex operator/(complex a1, complex a2)
{
	...
	//real = (a1.re*a2.re + a1.im*a2.im)/(a2.re*a2.re + a2.im*a2.im)
	//img = (a1.im*a2.re - a1.re*a2.im)/(a2.re*a2.re + a2.im*a2.im)
	
	//return complex(a1.re/a2.re, a1.im/a2.im);
	return complex((a1.re*a2.re + a1.im*a2.im)/(a2.re*a2.re + a2.im*a2.im),(a1.im*a2.re - a1.re*a2.im)/(a2.re*a2.re + a2.im*a2.im)); 
}
